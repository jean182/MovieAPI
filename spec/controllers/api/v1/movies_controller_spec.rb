...
RSpec.describe Api::V1::MoviesController, type: :controller do
  ...
  let(:valid_attributes) {
    { name: 'Scarface', plot: 'Tony Montana was here', release_date: Date.current }
  }

  let(:invalid_attributes) {
    { name: nil, plot: nil, release_date: nil }
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        { plot: 'Say Hello to my little friend', release_date: Date.current }
      }
      ...
      it "updates the requested movie" do
        ...
        movie.reload
        expect(movie.attributes).to include("plot" => 'Say Hello to my little friend')
      end
